...
const DarkTheme = ({setTheme}:any) => {
    ...
    return (
      <div className=" w-[1156px] h-[572px] pt-[64px] bg-black-background rounded-[20px] flex flex-col items-center ">
        ...
        <div onClick={handleToggle} className="bg-[#37322f]  rounded-[10px] mt-[26px] mb-4 flex text-[#fbfaf9] py-2 pl-4 font-[500] pr-4 shadow-effect-editor-button text-[14px] leading-5 cursor-default "> Light Theme </div>
        <Image src={Dark} alt="light" width={1030} height={314} className="  translate-y-[26px] " />
        </div>
    );
}
