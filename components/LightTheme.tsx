...
const LightTheme = ({ setTheme }: any) => {
  ...
  return (
    <div className=" w-[1156px] h-[572px] pt-[64px] bg-background-color rounded-[20px] flex flex-col items-center ">
      <h3 className=" text-4xl text-heading-black  ">Customize your themes</h3>
