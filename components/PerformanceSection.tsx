  ...
  return (
    <div className=' flex flex-col items-center '>
        ...
        <div className='grid grid-cols-2 grid-rows-1 gap-5 mb-5 '>
            <div className='w-[568px] h-[552px] bg-black-background rounded-[22px] '>
                <div className=' h-[228px] p-12 mb-4  '>
                    <div className='mb-4 badge flex items-center justify-center py-1 px-2 w-[150px] h-6 rounded-full text-xs '>Analyze together</div>
                    <h3 className=' text-[36px] leading-[40px] text-background-color ' >Collaborate in real time</h3>
                    <p className=' text-sm mt-3  text-[#aba8a6] '>Stay in flow and get to insights faster with iteractions <br/> taht feel instantaneous thanks to smart syncing.</p>
                </div>
                <Image src={Analyze} alt='focus' width={567} height={308} className=' rounded-b-[22px] ' />
            </div>
        </div>
        </div>
    </div>
